...
<div class ="center">
	...
	<h3>(3) 비방 또는 분란을 조장하는 허위사실이나 근거 없는 정보를 유포해서는 안됩니다.</h3><br>
	...
	<h3>(3) 타인의 재산권을 침해하는 내용이거나 허위의 사실로 영업을 방해할 목적의 게시물을 작성하지 않습니다. </h3><br>
	...
	<h3>(3) 고의적으로 규칙위반 게시물 작성 후 삭제를 반복하는 경우 작성자는 이용이 제한될 수 있습니다. </h3><br>
	<h2>4.  특정 집단에 대한 차별 및 무조건적 비난 금지</h2>
	<h3>(1) 인종, 성별, 국적, 연령, 지역, 장애 등 구분이 가능한 집단에 대하여 그 구성원에게 굴욕감이나 불이익을 줄 수 있는 게시물을 작성하지 않습니다. </h3>
	<h3>(2) 학벌, 재산, 직업, 생활양식, 취향, 종교, 정치적 견해 등을 이유로 무조건적인 비난을 하지 않습니다. </h3><br>
	</div>

<div class="main-content">
		<div class="test">
    <h2>후기게시판 <a href="list.do?category=latterboard" class="link">더보기</a></h2>
    <table class="community-table">
      <tr>
        <td><span>제목</span><span style="float: right;">작성자&emsp;작성일</span></td></tr>
        <c:forEach var="article" items="${latestLatterboardArticles}">
            <tr>
                <td><a href="read.do?no=${article.number}">${article.title}</a>
                    <span style="float: right;">${article.writer.name}&emsp; ${article.formattedRegDate}</span></td>
            </tr>
        </c:forEach>
    </table>
</div>
...
<div class="test">
    <h2>자유게시판 <a href="list.do?category=freeboard" class="link">더보기</a></h2>
    <table class="community-table">
    <tr>
        <td><span>제목</span><span style="float: right;">작성자&emsp;작성일</span></td></tr>
...
<div class="test">
    <h2>동행게시판 <a href="list.do?category=togetherboard" class="link">더보기</a></h2>
    <table class="community-table">
    <tr>
        <td><span>제목</span><span style="float: right;">작성자&emsp;작성일</span></td></tr>
