				...
				<div id="image-upload-container" class="image-upload-container">
					<div class="image-upload-center">
						<div class="image-upload">
							<p>대표이미지 추가</p>
							<input type="file" name="file5" accept="image/*"> <i
								class="fa fa-plus"></i>
						</div>
					</div>
					<div class="image-upload-bottom">
						<div class="image-upload">
							<p>이미지 추가</p>
							<input type="file" name="file1" accept="image/*"> <i
								class="fa fa-plus"></i>
						</div>
						<div class="image-upload">
							<p>이미지 추가</p>
							<input type="file" name="file2" accept="image/*"> <i
								class="fa fa-plus"></i>
						</div>
						<div class="image-upload">
							<p>이미지 추가</p>
							<input type="file" name="file3" accept="image/*"> <i
								class="fa fa-plus"></i>
						</div>
						<div class="image-upload">
							<p>이미지 추가</p>
							<input type="file" name="file4" accept="image/*"> <i
								class="fa fa-plus"></i>
						</div>
					</div>
				</div>
			...
			<div class="details-pricing-container">
				<div class="details-section">
					...
					<div class="content-info">
						<label>Product_Content: <br> <textarea name="content"
								rows="5" cols="100">${param.productContent}</textarea></label>
					</div>
				</div>
		...
		document.addEventListener('DOMContentLoaded', function() {
			...
			function handleDeleteButtonClick(event) {
				if (event.target.classList.contains('delete-button')) {
					...
					var deleteButton = parentDiv
							.querySelector('.delete-button');
					if (img)
						img.remove();
					if (deleteButton)
						deleteButton.remove();
					var fileInput = parentDiv
